...
void main() {
  testWidgets('Course detail disables enroll when status exists', (
    tester,
  ) async {
    await mockNetworkImagesFor(() async {
      ...
      final btnFinder = find.byKey(const Key('course_detail_enroll_button'));
      expect(btnFinder, findsOneWidget);

      final btn = tester.widget<ElevatedButton>(btnFinder);
      expect(btn.onPressed, isNull);

      // Also verify the status badge is visible.
